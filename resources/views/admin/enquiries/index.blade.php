{{-- resources/views/admin/enquiries.blade.php --}}
@extends('layouts.admin')

@section('content')
<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
        <form action="{{ route('admin.enquiries.index') }}" method="GET" class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('admin.enquiries.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 transition ease-in-out duration-150">
                        Reset
                    </a>
                </div>
            </div>
        ...
        <div class="px-6 py-5 border-b border-gray-200">
            <div class="flex flex-wrap items-center justify-between -mt-2 -ml-4">
                ...
                <div class="mt-4 ml-4 flex-shrink-0">
                    ...
                    {{--<a href="{{ route('admin.enquiries.create.single', ['id' => $pid]) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Add New enquiry
                    </a>--}}
                </div>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        clickableElements.forEach(function (elem) {
            elem.addEventListener("click", function () {
                ...
                window.location.href = `/admin/enquiry/${enquiryId}`;
            });
        });
    });
</script>
