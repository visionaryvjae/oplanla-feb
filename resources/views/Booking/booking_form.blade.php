    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <form method="POST" action="{{ $actionUrl }}" id="main_form" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-8">
                ...
                @if ($table == 'Provider')
                    <div class="form-content flex flex-col space-y-4">
                        {{-- <div>
                            <label for="room_number" class="block text-sm font-medium text-gray-700">Room Number</label>
                            <input type="text" name="room_number" id="room_number" value="{{ old('room_number') ?? $room->room_number }}" required class="">
                        </div> --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="provider_name">Provider Name: </label>
                            <input 
                                type="text" 
                                name="provider_name" 
                                id="provider_name"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700" for="description">Provider Description: </label>
                            <textarea 
                                class="mt-1 block w-full p-2 shadow-sm sm:text-sm border-gray-300 rounded-md"
                                name="description" 
                                id="description" 
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Select the amenities available in your accommodation.</p>
                            <div class="mt-2">
                            ...
                            <input type="hidden" name="room_facilities" id="room_facilities" value="{{ old('room_facilities', $provider->provider_facilities) }}">
                        </div>

                        <div style="flex-direction:column;">
                            <div class="content-container">
                                <label class="block text-sm font-medium text-gray-700" for="booking_address">Address: </label>
                                <input 
                                    type="text" 
                                    name="booking_address" 
                                    id="location"
                                    value="{{old('booking_address') ?? $provider->booking_address}}"
                                    class="mt-1 block w-full p-2 shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    required
                                >
                            </div>
                ...
                @if ($table == 'Room')
                    ...
                    <div>
                        ...
                        {{-- MODIFIED: Added checkbox and new hidden input for provider facilities --}}
                        @if(empty($room->provider->facilities))
                        <div class="mt-4">
                            <label for="apply_to_provider" class="inline-flex items-center">
                                <input type="checkbox" id="apply_to_provider" name="apply_to_provider" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <span class="ml-2 text-sm text-gray-600">Apply these facilities to all rooms for this provider (sets default)</span>
                            </label>
                        </div>
                        @endif
                        
                        <input type="hidden" name="room_facilities" id="room_facilities" value="{{ old('room_facilities', $room->room_facilities) }}">
                        <input type="hidden" name="provider_facilities" id="provider_facilities">
                    </div>
                ...
                @if ($table == 'Image')
                    ...
                    <div>
                        ...
                        <input type="file" name="image" id="image" required class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
