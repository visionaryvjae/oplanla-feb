...
@section('content')
    ...
    <style>
        ...
        .carousel-image.zoomed {
            transform: scale(1.5);
            cursor: move;
            /* REMOVE THIS LINE: object-fit: cover; */
        }
    ...
    <div class="main-container">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" style="max-width: 70rem;">
            ...
            <div class="lg:flex lg:flex-col">
                <!-- Left Column: Details -->
                <div class="lg:w-full">
                    <div class="pb-6 border-b border-gray-200" style="padding-bottom: 1.4rem;">
                        ...
                        <div class="flex w-full items-center" style="justify-content:space-between;">
                            <p class="text-gray-600 mt-1" style="margin-top: 0.5rem;">{{ $room->num_people }} guests • {{ $room->num_beds }} Bedrooms • {{ $room->num_bathrooms }} bathrooms</p>
                            <div class="flex">
                ...
                <aside class="lg:w-full">
                    <div class="bg-white p-6 rounded-lg shadow-lg sticky top-8">
                        <p class="text-2xl font-bold text-gray-900 mb-4">
                            ZAR {{ $room->price * config('app.markup') }} <span class="text-base font-normal text-gray-600">/ night</span>
                        </p>
                        <form action="" method="POST">
                            <div class="border border-gray-300 rounded-lg p-4">
                                ...
                                >
                                    <div>
                                        ...
                                        <input type="datetime" id="check_in_time" name="check_in_time" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    </div>
                                    <div>
                                        <label for="check_out_time" class="block text-xs font-bold text-gray-700 uppercase">Checkout Date</label>
                                        <input type="datetime" id="check_out_time" name="check_out_time" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    </div>
                                </div>
                                <div>
                                    <label for="guests" class="block text-xs font-bold text-gray-700 uppercase">Guests</label>
                                    <select id="guests" name="guests" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <option value="1">1 Guest</option>
                                        @for ($i = 2; $i <= $room->num_people; $i++)
                            ...
                            <button 
                                id="submit-btn"
                                type="submit" 
                                class="mt-4 w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-700 transition duration-300"
                                style="
                                    margin-top:1rem; 
                                    width:100%; 
    ...
    @include('Booking.Rooms.room-components.make-reservation', compact('room'))
