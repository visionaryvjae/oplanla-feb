...
@include('providers.images.components.actions-buttons')

<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
    <div class="mb-4">
        <a href="{{ route('provider.image.index', $providerId) }}" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
